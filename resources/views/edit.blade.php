...
<body class="bg-light">
    ...
    <div class="navbar">
        <div class="heading">
            <h2 style="font-size: 20px">Edit Product</h2>
        </div>
        <div class="btn">
    ...
    <div class="container">
        <div class="container mt-5">
            <form action="{{url('products/edit/'.$product->id)}}" class="form" method="POST" name="addProduct">
                @csrf
                <div class="form-group mt-2">
                    <label class="mb-2" for="name">Product Name</label>
                    <input value="{{$product->productName}}" type="text" name="Productname" id="" class="form-control w-50">
                    @if($errors->any())
                ...
                <div class="form-group mt-2">
                    ...
                    <textarea name="Description" id="" class="form-control w-50" rows="2">{{$product->productDescription}}</textarea>
                    @if($errors->any())
                ...
                <div class="form-group mt-2">
                    ...
                    <input value="{{$product->quantity}}" type="number" name="Quantity" id="" class="form-control w-50">
                    @if($errors->any())
                ...
                <div class="form-group mt-2">
                    ...
                    <input value="{{$product->price}}" type="number" name="Price" id="" class="form-control w-50">
                    @if($errors->any())
                        <div class="text-danger mt-1 mb-3">{{$errors->first('Price')}}</div>
                    @endif
                </div>
                <div class="d-flex gap-4 mt-4">
                    <button style="width:80px" class="btn btn-success" type="submit">Update</button>
                </div>
            </form>
    </div>
